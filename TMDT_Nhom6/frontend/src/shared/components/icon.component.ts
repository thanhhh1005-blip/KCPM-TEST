...
@Component({
  ...
  template: `
    ...
    @if (name === 'heart') {
       <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.28 3.6-2.34 3.6-4.96C22.6 5.61 20.3 3.5 17.5 3.5c-1.8 0-3.35.94-4.25 2.37C12.35 4.44 10.8 3.5 9 3.5c-2.8 0-5.1 2.11-5.1 5.54 0 2.62 2.1 3.68 3.6 4.96L12.5 21l6.5-7z"/></svg>
    }
    @if (name === 'star-filled') {
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
    }
